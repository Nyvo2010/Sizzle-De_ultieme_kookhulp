...
<head>
    ...
    <title>Mijn Favorieten - Sizzle</title>
    ...
    <div class="container">
        <header>
            ...
            <div class="header-icons">
                <span class="material-symbols-rounded" onclick="window.location.href='index.php'" style="cursor: pointer;">home</span>
        ...
        <section class="favorites-section">
            ...
            <div id="favorites-container" class="recipe-scroll-container">
