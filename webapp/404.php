...
<head>
    ...
    <title>404 - Pagina niet gevonden | Sizzle</title>
    ...
    <div class="container">
        <header>
            ...
            <div class="header-icons">
                ...
                <span class="material-symbols-rounded" onclick="window.location.href='profile.php'" style="cursor: pointer;">person</span>
            </div>
        </header>

        <section class="error-section">
            <div class="error-code">404</div>
            <h1 class="error-title">Oeps! Je hebt een ingrediënt gemist...</h1>
            <p class="error-message">Deze pagina is zo onvindbaar als een vergeten snufje zout in je favoriete recept.</p>
            <button class="primary-btn" onclick="window.location.href='index.php'">
